...
export default function Credit_Note_List() {
  ...
  // ✅ Print with working QR code even in PDF
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  const handlePrint = async (item: any) => {
    const qrData = `https://e.fbr.gov.pk/creditnote/${item.invoiceNo}`;
    ...
    printWindow.document.write(`
      <html>
        <head>
          <title>Credit Note Invoice - ${item.invoiceNo}</title>
        ...
        <body>
          <div class="invoice-box">
            <div class="header">
              ...
              <p>Lahore</p>
              <h2 class="text-lg font-semibold underline mt-3">CREDIT NOTE INVOICE</h2>
            </div>
            ...
            <div class="buyer-info grid grid-cols-2 gap-4">
              ...
              <div class="text-right">
                <p><strong>Credit Note #:</strong> ${item.invoiceNo}</p>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td class="text-left">Returned Goods</td>
            ...
            <div class="flex justify-between items-center mt-12">
              ...
              <div class="text-center">
                ...
                <p class="text-xs mt-2 text-gray-700 font-medium">
                  FBR Credit Note No: ${item.invoiceNo}
                </p>
              </div>
            </div>
        ...
        <table className="w-full border-collapse bg-white rounded-md shadow-sm">
          <thead>
            <tr className="bg-gray-200 text-gray-800">
              ...
              <th className="p-3 text-left">CREDIT NOTE NO</th>
                  ...
                  <td className="p-3 flex gap-3 items-center">
                    ...
                    {item.posted ? (
                      ...
                      <button
                        ...
                        onClick={() => alert("Posting Credit Note to FBR...")}
                      >
                        Post to FBR
                      </button>
                    )}
